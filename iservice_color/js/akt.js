                ...
                <td><i>дата приема</i> <span class="date">'+im[0].value+'</span></td>\
                 ...
                 <tr>\
                  <td><i>Код безопасности</i> '+im[9].value+'</td>\
                                                          ...
                                                          <tr>\
                <td><i>Описание неисправности</i> '+opis[0].value+'</td>\
              </tr>\
                                                        <tr>\
...
\
 ...
 newAkt.document.write(' </div><div class="information clear">\
	      <div>\
	      	\
	    <h4>Пожалуйста ознакомьтесь с условиями ремонта и сдачи устройства в сервис.</h4>\
...
\
        <div class="row">\
          <div class="col col-xs-6">\
            <p style="border-bottom: 1px solid #777; margin: 40px 40px 10px;">Заказчик</p>\
          </div>\
          <div class="col col-xs-6">\
            <p style="border-bottom: 1px solid #777; margin: 40px 40px 10px;">Исполнитель</p>\
          </div>\
        </div>\
\
...
// создать div в документе нового окна
   var div = newAkt.document.createElement('div');
      var qr = newAkt.document.getElementById("barQR");
